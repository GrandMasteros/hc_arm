...
HD_PWD='C:/Users/Marcin/Vivado/hc_arm/hc_arm.runs/codec_system_Codec_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log codec_system_Codec_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source codec_system_Codec_0_0.tcl
