...
HD_PWD='C:/Users/Marcin/Vivado/hc_arm/hc_arm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log codec_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source codec_system_wrapper.tcl -notrace
